...
// Kijelentkezés függvény megerősítéssel
function logoutUser() {
            ...
            <div class="modal fade" id="logoutConfirmModal" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content" style="background: #1a1a1a; border: 1px solid #333;">
                        ...
                        <div class="modal-body" style="color: #ccc; padding: 20px;">
                            <p style="margin: 0; font-size: 1.1rem;">Biztosan ki szeretnél jelentkezni a fiókodból?</p>
                        </div>
                        <div class="modal-footer" style="border-top: 1px solid #333;">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Mégse</button>
                            <button type="button" class="btn" style="background: #d4a528; color: #000; font-weight: 500;" id="confirmLogoutBtn">Kijelentkezés</button>
                        </div>
                    </div>
                </div>
            </div>
