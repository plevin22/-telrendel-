...
public class UsersService {
    ...
    //  REGISZTRÁCIÓ (HASH + EMAIL + STORED PROCEDURE)
    ...
    public JSONObject createUser(String name, String email, String passwordHash, String phone, String address, String role) {
